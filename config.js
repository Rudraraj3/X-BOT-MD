...
const BOT_INFO = process.env.BOT_INFO || "◦•●◉✿ 𝘼𝙣𝙟𝙖𝙣-𝙎𝙚𝙧 ✿◉●•◦;◦•●◉✿ 𝘼𝙣𝙟𝙖𝙣-𝙎𝙚𝙧 ✿◉●•◦;https://i.imgur.com/Xi87P5B.jpeg";
const URL = process.env.URL || "https://www.instagram.com/imspxxky";
const AUDIO_DATA = process.env.AUDIO_DATA || "◦•●◉✿ 𝘼𝙣𝙟𝙖𝙣-𝙎𝙚𝙧 ✿◉●•◦;◦•●◉✿ 𝘼𝙣𝙟𝙖𝙣-𝙎𝙚𝙧 ✿◉●•◦;https://i.imgur.com/Xi87P5B.jpeg";
const STICKER_DATA = process.env.STICKER_DATA || "🎗𝐌𝐫-𝐚𝐧𝐣𝐚𝐧🎗";
